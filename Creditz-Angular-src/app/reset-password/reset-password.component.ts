  ...
  onSubmitForm() {
    this.userService
      .findUserByEmailAndPassword(
        this.userModel1.userEmail,
        this.userModel2.password
      )
      .subscribe((data) => {
        if (data.userEmail === null) {
          window.alert(
            "Your Email or Password is incorrect, Please enter a valid Email and Password!"
          );
        } else {
          this.userService
            .updateUser(this.userModel1.userEmail, this.userModel1.password)
            .subscribe((data) => {
