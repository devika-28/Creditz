...
public interface OrganizationApplicationRepository extends JpaRepository<OrganizationApplicant, Long> {
     ...
     * @param age  int buisness age
     * @param employeeCount employee count
     * @param licenseNumber String license 
    ...
    @Query(nativeQuery = true,
            value = "SELECT *FROM organizationapplicant,cibil_report WHERE organizationapplicant.pan_card=cibil_report.pan_card  AND application_status= :applicationStatus GROUP BY user_id  ORDER BY credit_score DESC LIMIT 10")
