...
public class MailService {
	...
	static final String REJECTEDLIMIT = "Dear Applicant," + "\n\n" + "We are sorry to inform you but your application got rejected, kindly try again by maintaining the minimum and maximum limit requirements";
